...
sales_train_validation <- read_csv("m5-forecasting-uncertainty/sales_train_validation.csv", 
...
cleanCAHOBS <- function(df){ #create groups
  subDept <- function( df ){
    for (i in 1:length(df$dept_id)){
      df$dept_id[i] <- str_c(str_sub(df$dept_id[i], 1,4), 
                             str_sub(df$dept_id[i], -2,-1), sep = "")
    }
    df
  }
  ...
  subItem <- function( df ){
    for (i in 1:length(df$item_id)){
      df$item_id[i] <- str_c(df$dept_id[i], 
                             str_sub(df$item_id[i], -3,-1), sep = "_")
    }
    df
  } 
...
#
head(cal_CA_sell_CA_1_clean_train_reg) %>% View()
head(cal_CA_sell_CA_1_clean_forcast_reg) %>% View()
...
for (level in c(0.5, 2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_1HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_1HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_1HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_1HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_1FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_1FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
CADataCA_2HobbiesCleanT <- t(CADataCA_2HobbiesClean[,-1914])
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_2HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_2HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_2HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_2HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_2FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_2FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_3HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_3HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_3HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_3HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_3FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_3FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_4HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_4HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_4HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_4HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(CADataCA_4FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/CADataCA_4FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
#TXSales2 <- t(TXSales[,-1914])  #check dim and rownames and colnames
...
for (level in c(0.5,2.5, 16.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_1HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_1HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_1HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_1HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_1FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_1FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_2HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_2HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_2HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_2HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_2FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_2FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_3HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_3HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5,  25, 50, 75, 83.5, 97.5, 
  ...
  write_csv(as.data.frame(TXDataTX_3HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_3HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(TXDataTX_3FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/TXDataTX_3FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
#WISales2 <- t(WISales[,-1914])  #check dim and rownames and colnames
...
for (level in c(0.5,2.5, 16.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_1HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_1HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_1HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_1HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_1FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_1FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_2HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_2HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_2HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_2HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 
  ...
  write_csv(as.data.frame(WIDataWI_2FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_2FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_3HobbiesCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_3HobbiesCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time()
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_3HouseholdCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_3HouseholdCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
...
for (level in c(0.5,2.5, 16.5, 25, 50, 75, 83.5, 97.5, 99.5)){
  ...
  write_csv(as.data.frame(WIDataWI_3FoodCleanTT_hts_aggts_forecast_ts_f), 
            file.path(glue::glue("m5UV/WIDataWI_3FoodCleanTT_hts_aggts_forecast_ts_f_{level}.csv") ) 
  ) 
}
Sys.time() 
