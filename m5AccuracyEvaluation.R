...
sales_train_evaluation <- read_csv("m5-forecasting-accuracy/sales_train_evaluation.csv", 
...
CADataCA_2HobbiesCleanT <- t(CADataCA_2HobbiesClean[,-1914])#[,-1942])
...
cal_CA_sell_CA_2_clean_train_reg <- cal_CA_sell_CA_2_clean[1:1913, ]#[1:1941, ]
cal_CA_sell_CA_2_clean_forcast_reg <- cal_CA_sell_CA_2_clean[1914:1941,]#[1942:1969,]
